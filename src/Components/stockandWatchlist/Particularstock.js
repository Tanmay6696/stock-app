  ...
  return (
    <div className='card' >
      ...
      <div style={{ display: 'flex', alignItems: 'center' }}>
        ...
        <h5 style={{color:'black'}} >{symboltoParticularstock.symbol || 'APPLE'}</h5>   
        <h5 className='PriceText' style={{ marginLeft: 'auto', marginRight: '10px', color: 'black' }}>
  {"$" + symboltoParticularstock.currentPrice || '238'}
</h5>
